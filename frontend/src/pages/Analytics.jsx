  ...
  return (
    <div className="min-h-screen bg-[#0b1220]">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        {realtimeMetrics && (
          <div className="mb-8">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-xl font-bold text-slate-100">Real-time Metrics</h3>
              {realtimeLoading && (
        ...
        {predictiveAnalytics && (
          <div className="mb-8">
            <h3 className="text-2xl font-bold text-slate-100 mb-4">Predictive Analytics</h3>
        ...
        {overview && (
          <div className="mb-8">
            <h3 className="text-2xl font-bold text-slate-100 mb-4">Performance Insights</h3>
