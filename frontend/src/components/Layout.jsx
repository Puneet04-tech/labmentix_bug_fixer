  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-950 via-green-900 to-teal-900 text-slate-50 relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-32 bg-gradient-to-r from-orange-500/15 via-pink-500/12 to-purple-500/15 transform -rotate-6 translate-y-8 blur-sm"></div>
        <div className="absolute top-1/4 right-0 w-full h-24 bg-gradient-to-l from-red-500/13 via-orange-400/10 to-yellow-500/12 transform rotate-3 translate-y-6 blur-sm"></div>
        <div className="absolute bottom-1/3 left-0 w-full h-28 bg-gradient-to-r from-purple-500/12 via-pink-400/11 to-red-500/13 transform -rotate-2 translate-y-4 blur-sm"></div>
        <div className="absolute bottom-0 right-0 w-full h-36 bg-gradient-to-l from-yellow-500/15 via-orange-500/12 to-red-400/13 transform rotate-5 translate-y-10 blur-sm"></div>
        <div className="absolute top-1/2 left-1/4 w-3/4 h-20 bg-gradient-to-r from-pink-500/11 via-purple-500/10 to-orange-500/12 transform rotate-1 translate-y-2 blur-sm"></div>
      </div>
